...
###### For Ubuntu 20.04 (Bionic) users:

-   `sudo add-apt-repository "deb http://apt.llvm.org/focal/ llvm-toolchain-focal-15 main"`

###### For Ubuntu 22.04 (Bionic) users:
...
*   `sudo apt-get update`
*   `sudo apt-get install aptitude -y`
*   `sudo aptitude install -y build-essential clang-6.0 libstdc++-7-dev git libboost-all-dev libssl-dev cmake libstdc++-10-dev`
*   `sudo pip install cmake`
*   `export CC=clang-6.0`
